...
class View {
	...
	**/	
	public static function load($view){
		// Module::$module;
		if(!isset($_GET['view'])){
			include "apps/".App::$appname."/modules/".Module::$module."/view/".$view."/widget-default.php";
		}else{


			if(View::isValid()){
				include "apps/".App::$appname."/modules/".Module::$module."/view/".$_GET['view']."/widget-default.php";				
			}else{
	...
	**/	
	public static function isValid(){
		$valid=false;
		if(file_exists($file = "apps/".App::$appname."/modules/".Module::$module."/view/".$_GET['view']."/widget-default.php")){
			$valid = true;
		}
		return $valid;
	}
